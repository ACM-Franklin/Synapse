...
-- Durable state for historical scan runs.
...
-- Durable state for admin-triggered reward replay runs.
...
-- Last seen message checkpoint per guild message-bearing surface.
